...
class ActivityViewModel(flag:String, warehouse:String="", objType:Int=0): ViewModel() {
    ...
    class ActivityViewModelFactory(private var flag: String,private var wareHouse:String="",private var objType:Int=0) : ViewModelProvider.Factory {
        @Suppress("UNCHECKED_CAST")
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            return ActivityViewModel(flag, wareHouse,objType ) as T
        }
    }
