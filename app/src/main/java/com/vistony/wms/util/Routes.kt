...
sealed class Routes(val route: String,val title:String,val icon:Int) {
    object Recuento : Routes("Recuento","Crear recuento", R.drawable.ic_baseline_keyboard_24)
    ...
    object ListInventory : Routes("ListInventory","Historial de recuento", R.drawable.ic_baseline_keyboard_24)
